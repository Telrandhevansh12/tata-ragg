...
def extract_everything_from_pdf(pdf_path):
    ...
    for page_num in range(len(doc)):
        ...
        for img_index, img in enumerate(image_list):
            ...
            print(f" -> Asking llama3.2-vision to describe image {img_index + 1}...")
            ...
            try:
                ...
                response = ollama.chat(
                    ...
                    messages=[{
                        ...
                        'content': 'Describe this image, chart, or diagram in detail for a data retrieval system. Focus on numbers, labels, timelines, and meanings.',
                ...
                formatted_description = f"[IMAGE CONTEXT FROM PAGE {page_num+1}]: {image_description}"
...
text = extract_everything_from_pdf('sample.pdf')
